...
# Jira EC2 Security Group
resource "aws_security_group" "jira" {
  name        = "${var.project_name}-${var.environment}-jira-sg"
  description = "Security group for Jira EC2 instance"
  vpc_id      = aws_vpc.main.id
...
resource "aws_security_group" "rds" {
  ...
  ingress {
    description     = "PostgreSQL from Jira EC2"
    from_port       = 5432
    to_port         = 5432
    protocol        = "tcp"
